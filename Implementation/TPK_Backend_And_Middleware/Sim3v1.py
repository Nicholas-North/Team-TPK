...
class CombatSimulation:
    def __init__(self):
        ...
        if len(self.selected_players) != 4:
            print("Error: The selected players list does not have exactly 4 players.")
            return
        
        self.team_players = self.selected_players[:3]  # The two team members
        self.solo_player = self.selected_players[3]   # The solo player

        # Assign individual team players
        self.p1, self.p2, self.p3= self.team_players
